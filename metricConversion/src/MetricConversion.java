...
public class MetricConversion {
    ...
    public static void main(String[] args) {
        ...
        int userChoice; //Stores conversion choice
        double convertedNum = 0; //Stores converted number

        System.out.print("Please enter a number to convert: ");
        userNum = userInput.nextDouble(); //Get user input
        ...
        userChoice = userInput.nextInt(); //Get user choice
        /*
         * the following if statements will call a method
         * the methods called, perform a different conversion
         * the user chooses a method of conversion (inches to centimeters, yards to miles, etc)
         * and once the method is called, the conversion is performed
         * and the converted number is displayed
         */
        if (userChoice == 1){
